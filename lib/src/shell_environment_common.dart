...
class ShellEnvironmentPaths with ListMixin<String> {
  ...
  List<String> get _paths {
    final String? pathVar = _environment[envPathKey];
...
class ShellEnvironmentVars with MapMixin<String, String> {
  ...
  @override
  void clear() {
    removeWhere((String key, String value) => !_ignoreKey(key));
  }

  @override
  Iterable<String> get keys =>
      _environment.keys.where((String key) => !_ignoreKey(key));
