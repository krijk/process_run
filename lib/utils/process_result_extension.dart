...
extension ProcessRunProcessResultsExt on List<ProcessResult> {
  ...
  Iterable<String> get outLines =>
      _outLinesToLines(map((ProcessResult result) => result.outLines));

  /// Line lists
  Iterable<String> get errLines =>
      _outLinesToLines(map((ProcessResult result) => result.errLines));
}
