...
void main() {
  group('flutterbin_cmd', () {
    ...
    test('run_version', () async {
      ...
      final ProcessCmd cmd = FlutterCmd(<String>['--version']);
      // expect(cmd.executable, flutterExecutablePath);
      expect(cmd.arguments, <String>['--version']);
    ...
    test('get version', () async {
      final Version? version = await getFlutterBinVersion();
      if (version != null) {
    ...
    test('dart', () async {
      final String flutterDir = dirname((await which('flutter'))!);
      // New in 2.9
