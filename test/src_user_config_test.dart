...
void main() {
  group('src_user_config', () {
    final dummyEnvPath1 = join('test', 'data', 'test_env1.yaml_dummy');
    final dummyEnvPath2 = join('test', 'data', 'test_env2.yaml_dummy');
    test('dummy_file', () async {
      //print(a);
      final path1 = dummyEnvPath1;
      final path2 = dummyEnvPath2;
    ...
    test('simple', () async {
      //print(a);
      final path = join('test', 'data', 'test_env1.yaml');
      final userConfig = getUserConfig(<String, String>{
      ...
      final shEnv = ShellEnvironment.empty()
    ...
    test('config no overload', () async {
      final env = Map<String, String>.from(platformEnvironment)
        ..[userEnvFilePathEnvKey] = dummyEnvPath1
        ..[localEnvFilePathEnvKey] = dummyEnvPath1;
      final userConfig = getUserConfig(env);
